	...
	deploymentContainers := []corev1.Container{
		{
			...
			LivenessProbe: &corev1.Probe{
				...
				InitialDelaySeconds: krp.cr.Spec.LivenessProbe.InitialDelaySeconds,
				TimeoutSeconds:      krp.cr.Spec.LivenessProbe.TimeoutSeconds,
				PeriodSeconds:       krp.cr.Spec.LivenessProbe.PeriodSeconds,
				SuccessThreshold:    krp.cr.Spec.LivenessProbe.SuccessThreshold,
				FailureThreshold:    krp.cr.Spec.LivenessProbe.FailureThreshold,
			},
			ReadinessProbe: &corev1.Probe{
				ProbeHandler: corev1.ProbeHandler{
					Exec: krp.getExecCommand(readinessCommand),
				},
				InitialDelaySeconds: krp.cr.Spec.ReadinessProbe.InitialDelaySeconds,
				TimeoutSeconds:      krp.cr.Spec.ReadinessProbe.TimeoutSeconds,
				PeriodSeconds:       krp.cr.Spec.ReadinessProbe.PeriodSeconds,
				SuccessThreshold:    krp.cr.Spec.ReadinessProbe.SuccessThreshold,
				FailureThreshold:    krp.cr.Spec.ReadinessProbe.FailureThreshold,
			},
			Env:             envs,
