...
| akhq.envoyGateway.parentRefs             | list    | no        | [{"name":"default-external-gateway","namespace":"envoy-gateway"}] | Defines the Gateway resources that the AKHQ HTTPRoute attaches to.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| cruiseControl.envoyGateway.parentRefs   | list    | no        | [{"name":"default-external-gateway","namespace":"envoy-gateway"}]           | Defines the Gateway resources that the Cruise Control HTTPRoute attaches to.                                                                                                                                                                                                                                                                                                            |
