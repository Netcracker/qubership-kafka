...
| global.tls.enabled                         | boolean | no        | false         | Whether to use TLS to connect to all Kafka services. If you Upgrade Kafka from non-TLS to TLS, then disable kafka.rollingUpdate in deploy parameters.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
It can be enabled with `kafka.rollingUpdate: true`, by default it is enabled. If you Upgrade Kafka from non-TLS to TLS, then disable kafka.rollingUpdate in deploy parameters.
