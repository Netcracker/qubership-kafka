...
| pvc.metadata.annotations                               | object  | no        | {}                            | Custom annotations copied to Kafka broker PVCs and the kraft-controller PVC created by the operator. Use this parameter to set Argo CD `argocd.argoproj.io/sync-options: Prune=false`. When the parameter is omitted or empty, existing PVC annotations are not changed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| pvc.metadata.annotations                                      | object  | no        | {}                                                                            | Custom annotations copied to the Backup Daemon PVC. Use this parameter to set Argo CD `argocd.argoproj.io/sync-options: Prune=false`. When the parameter is omitted or empty, only the built-in `helm.sh/resource-policy: keep` annotation is set.                                                                                                                                                                                                          |
