...
| kafka.storage.size                                     | string  | no        | 1Gi                           | The size of the persistent volume in Gi. Increasing this value is supported when the StorageClass has `allowVolumeExpansion: true`. Decreasing the size is not supported.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
