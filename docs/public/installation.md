...
| kafka.rollingUpdate                                    | boolean | no        | true                          | Specifies either to redeploy Kafka pods during update one by one or all in the same time. If `true` is specified, after every Kafka broker update there is a check of all brokers status. But if you Upgrade Kafka from non-TLS to TLS, then disable rollingUpdate in deploy parameters.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
It can be enabled with `kafka.rollingUpdate: true`.
