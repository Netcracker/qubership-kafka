...
| global.secrets.kafka.adminPassword                    | string  | yes       | ""            | The password of the internal administrator Kafka user. Changing this password requires downtime: all brokers are restarted at once.                                                                                                                                                                                                                                                                                                      |
